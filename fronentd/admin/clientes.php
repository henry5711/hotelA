...
<body data-dark>
  ...
  <div class="col-6" style="margin-left: 200px; margin-top: 150px;">
    <a href="aggclientes.php" title="Agregar clientes">
    <div class="card h-100">
      <img src="../img/agregar.jpg" class="card-img-top " alt="clientes">
      <div class="card-body">
        <h5 class="card-title text-center">Agregar clientes  <i class="fas fa-plus-circle"></i></h5>
      </div>
    </div>
  </a>
  </div>
...
<!-- carta consulta -->
  <div class="col-6" style="margin-top: 150px;">
    ...
    <div class="card h-100">
      ...
      <div class="card-body">
        <h5 class="card-title text-center">Consultar clientes <i class="fas fa-clipboard-list"></i></h5>
      </div>
    </div>
      </a>
  </div>
